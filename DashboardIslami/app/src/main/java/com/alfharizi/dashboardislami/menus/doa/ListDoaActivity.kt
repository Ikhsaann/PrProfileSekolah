package com.alfharizi.dashboardislami.menus.doa
...
import com.alfharizi.dashboardislami.databinding.ActivityListDoaBinding
import com.alfharizi.dashboardislami.menus.doa.adapter.DoaListAdapter
import com.alfharizi.dashboardislami.menus.doa.data.*
import com.alfharizi.dashboardislami.menus.doa.model.DoaModel
...
class ListDoaActivity : AppCompatActivity() {
    ...
    private fun iniRecyclerView() {
        ...
        when (title) {
            getString(R.string.text_pagi_amp_malam) -> list.addAll(DoaMakananDanMinumanData.listDoaMakananDanMinumanData)
        ...
        val adapterDoa = DoaListAdapter(list, logo)
