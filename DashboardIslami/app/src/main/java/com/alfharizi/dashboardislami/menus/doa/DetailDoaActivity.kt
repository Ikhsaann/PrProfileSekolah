...
import com.alfharizi.dashboardislami.databinding.ActivityDetailDoaBinding
...
class DetailDoaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // menentukan actionbar dengan tolbar pada layout
        setSupportActionBar(binding.toolbarDetailDoa)
        supportActionBar?.title = doa.title
        // menampilkan data masing2 komponen layout
